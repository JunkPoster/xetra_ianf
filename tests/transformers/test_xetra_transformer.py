"""
  ...
  Author: Ian Featherston
    Date: 2025-03-14
    Desc: Contains Unit Tests for the XetraTransformer class
...
class TestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_tgt = 'tgt-bucket'
        ...
        # Creating the source and target configurations
        conf_dict_src = {
        ...
        # Unpack the respective configuration dictionaries into individual args
        ...
        columns_report = ['ISIN', 'Date', 'opening_price_eur',
                          'closing_price_eur', 'minimum_price_eur', 
                          'maximum_price_eur', 'daily_traded_volume', 
    ...
    def test_extract_no_file(self):
        ...
        return_value = [extract_date, extract_date_list]):
            xetra_etl = XetraETL(self.s3_bucket_src, self.s3_bucket_tgt,
                                self.meta_key, self.source_config,
                                self.target_config)
    ...
    def test_transform_report1_emptydf(self):
        """
        Tests the transform_report1 method with an empty DataFrame as input
        """
        # Expected results
    ...
    def test_transform_report1_ok(self):
        """
        Tests the transform_report1 method with a DataFrame as input
        """
        # Expected results
    ...
    def test_load(self):
        ...
        # Cleanup after test
        self.tgt_bucket.delete_objects(
            Delete={
                'Objects': [
                    {
                        'Key': tgt_file
