"""
    File: test_meta_process.py
  Author: Ian Featherston
    Date: 2025-03-14
    Desc: Contains the unit tests for the MetaProcess class.
...
class TestMetaProcessMethods(unittest.TestCase):
    ...
    def test_update_meta_file_meta_file_ok(self):
        """
        Tests the update_meta_file method when there's already a meta file
        """
        # Expected Results
    ...
    def test_return_date_list_no_meta_file(self):
        """
        Tests the return_date_list function when there IS NOT a meta file
        """
        # Expected Results
        date_list_exp = [
    ...
    def test_return_date_list_meta_file_ok(self):
        """
        Tests the return_date_list function when there IS a meta file
        """
        # Expected Results
        ## Creates a list of starting dates going back various lengths
        min_date_exp = [
            (datetime.today().date() - timedelta(days = 1)) \
                .strftime(MetaProcessFormat.META_DATE_FORMAT.value) ,
        ...
        # Creates a list of expected return date_lists in various ranges
        date_list_exp = [
            [(datetime.today().date() - timedelta(days = day)) \
                .strftime(MetaProcessFormat.META_DATE_FORMAT.value)
                for day in range(3)],
    ...
    def test_return_date_list_meta_file_wrong(self):
        """
        Tests the return_date_list function when there is a WRONG meta file
        """
        # Test init
        meta_key = 'meta.csv'
        meta_content = (
    ...
    def test_return_date_list_empty_date_list(self):
        """
        Tests the return_date_list function when there are no dates 
        to be returned
        """
        # Expected Results
