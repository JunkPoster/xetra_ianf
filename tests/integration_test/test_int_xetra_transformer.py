"""
    File: test_int_xetra_transformer.py
  Author: Ian Featherston
    Date: 2025-03-17
    Desc: Contains the integration tests for the XetraETL class.
...
class IntTestXetraETLMethods(unittest.TestCase):
    """
    Integreation testing the XetraETL Class.
    """
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-int-test-src-ianf'
        self.s3_bucket_name_tgt = 'xetra-int-test-tgt-ianf'
    ...
    def test_int_etl_replort1_no_metafile(self):
        """
